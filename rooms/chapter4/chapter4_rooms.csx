#load "room_dw_church_jackenstein.csx"
#load "room_dw_church_intropiano.csx"
...
#load "room_dw_church_intro_gerson.csx"

void Load_chapter4_rooms()
{
  Load_room_dw_church_intropiano();
  ...
  Load_room_dw_church_intro_gerson();
}
