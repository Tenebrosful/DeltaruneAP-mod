...
/// CODE
        ...
        scr_speaker("no_name");
        msgsetsubloc(0, string("* (Where once was a chest^1, you found {0}.)/", AP_get_location_reward_text(t_itemid)), "obj_dw_cliff_netskieclimb_behind_slash_Step_0_gml_34_0");
/// END