...
function scr_ap_step()
{
    if (global.darkzone == 1)
    {
        if (canshowtext)
        {
            ...
            if (global.interact == 0 && instance_exists(obj_fadein) == 0 && instance_exists(obj_fadeout) == 0 && instance_exists(obj_dialoguer) == 0 && global.fighting == 0 && obj_mainchara.climbing == 0 && global.customflags[29] == 0 && i_ex(obj_cutscene_master) == 0)
            {
                            ...
                            if (noroom == 0)
                            {
                                ...
                                if (notext == 0 && string_char_at(ds_list_find_value(dslistitems, index), 1) != "-")
                                {
                                    ...
                                    else if (trueitm >= 70000)
                                    {
                                        if (trueitm == 70003)
                                        {
                                            script_execute(scr_writetext, 0, "* (You got a Combination Lock Digit!)/%", 0, 6);
                                        }
                                        else
                                        {
                                            if (trueitm < 80000)
                                    ...
                                    {
                                        if ((trueitm == 10013 || (trueitm >= 10030 && trueitm <= 10031) || (trueitm >= 11020 && trueitm <= 11021)) || (trueitm >= 11005 && trueitm <= 11007) || (trueitm >= 11016 && trueitm <= 11017) || trueitm == 11020)
                                        {
                                            if (trueitm == 11021)
                                                trueitm = 10002;
