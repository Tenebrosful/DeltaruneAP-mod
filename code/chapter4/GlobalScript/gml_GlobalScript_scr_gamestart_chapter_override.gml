...
function scr_gamestart_chapter_override()
{
    ...
    scr_keyitemremove(1000);
    scr_keyitemremove(1001);
    scr_keyitemremove(1002);
    scr_keyitemremove(1003);
    scr_keyitemremove(1004);
    scr_keyitemremove(1005);
    scr_keyitemremove(1006);
    scr_keyitemremove(1007);
    scr_keyitemremove(1008);
    scr_keyitemremove(1009);
    scr_keyitemremove(1010);
    scr_keyitemremove(1011);
    scr_keyitemremove(1012);
    scr_keyitemremove(1013);
    scr_keyitemremove(1014);
    scr_keyitemremove(1015);
    scr_keyitemremove(1016);
    scr_keyitemremove(1017);
    scr_keyitemremove(1018);
    scr_keyitemremove(1019);
