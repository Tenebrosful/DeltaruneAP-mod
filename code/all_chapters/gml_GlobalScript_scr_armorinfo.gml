...
function scr_armorinfo(arg0)
{
    ...
    switch (arg0)
    {
        ...
        case 51:
            ...
            armordesctemp = stringsetloc("A silver armlet stained with amber.#Increases magic only.", "scr_armorinfo_slash_scr_armorinfo_gml_726_0");
        ...
        case 52:
            ...
            armordesctemp = stringsetloc("A silver armlet stained with red essence.#Increases strength only.", "scr_armorinfo_slash_scr_armorinfo_gml_747_0");
        ...
        case 53:
            ...
            armordesctemp = stringsetloc("Elegant lace ribbon with gloves,#delicate enough to see through.", "scr_armorinfo_slash_scr_armorinfo_gml_768_0");
    ...
    if (global.apbalancing == 1 && ch > 1)
    {
        ...
        armormagtemp = ceil(armormagtemp / ch);
