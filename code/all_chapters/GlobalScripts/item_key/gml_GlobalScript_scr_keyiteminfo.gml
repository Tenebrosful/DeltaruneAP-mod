...
function scr_keyiteminfo(arg0)
{
    ...
    switch (arg0)
    {
        ...
        case 701:
            tempkeyitemdesc = stringsetsubloc("A key segment generated by the KeyGen 2.#You have collected [~1] out of [~2].", global.MacGuffin_count, global.AP_macguffin_required[global.chapter - 1], "scr_keyiteminfo_slash_scr_keyiteminfo_gml_70_0");
            tempkeyitemname = stringsetloc("KeyGen2Segmnt", "scr_keyiteminfo_slash_scr_keyiteminfo_gml_71_0");
            tempkeyitemchapter = 2;
            break;

        case 702:
            tempkeyitemdesc = stringsetsubloc("An abnormally-sized AA battery.#You have collected [~1] out of [~2].", global.MacGuffin_count, global.AP_macguffin_required[global.chapter - 1], "scr_keyiteminfo_slash_scr_keyiteminfo_gml_70_0");
            tempkeyitemname = stringsetloc("RemoteBattery", "scr_keyiteminfo_slash_scr_keyiteminfo_gml_71_0");
            tempkeyitemchapter = 3;
            break;

        case 703:
            tempkeyitemdesc = stringsetsubloc("A digit for a combination lock.#You have collected [~1] out of [~2].", global.MacGuffin_count, global.AP_macguffin_required[global.chapter - 1], "scr_keyiteminfo_slash_scr_keyiteminfo_gml_70_0");
