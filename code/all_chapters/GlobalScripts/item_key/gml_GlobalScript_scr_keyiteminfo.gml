...
function scr_keyiteminfo(arg0)
{
    ...
    switch (arg0)
    {
        ...
        case 4:
            tempkeyitemdesc = string("It's {0} part(s) of a key.#A smith could fix all three parts.", global.customflags[global.custom_flags_indexes.broken_key_part_count]);
        ...
        case 13:
            var crystal_amount = global.customflags[global.custom_flags_indexes.shadow_crystal_amount];
            tempkeyitemusable = 1;
        ...
        case 31:
            ...
            break;
        case 700:
            tempkeyitemdesc = stringsetsubloc("A piece of a key shaped like a spade.#You have collected [~1] out of [~2].", global.MacGuffin_count, global.AP_macguffin_required[0], "scr_keyiteminfo_slash_scr_keyiteminfo_gml_70_0");
            tempkeyitemname = stringsetloc("KingKeyPiece", "scr_keyiteminfo_slash_scr_keyiteminfo_gml_71_0");
            tempkeyitemchapter = 1;
            break;
                
        case 701:
            tempkeyitemdesc = stringsetsubloc("A key segment generated by the KeyGen 2.#You have collected [~1] out of [~2].", global.MacGuffin_count, global.AP_macguffin_required[1], "scr_keyiteminfo_slash_scr_keyiteminfo_gml_70_0");
            tempkeyitemname = stringsetloc("KeyGen2Segmnt", "scr_keyiteminfo_slash_scr_keyiteminfo_gml_71_0");
            tempkeyitemchapter = 2;
            break;

        case 702:
            tempkeyitemdesc = stringsetsubloc("An abnormally-sized AA battery.#You have collected [~1] out of [~2].", global.MacGuffin_count, global.AP_macguffin_required[2], "scr_keyiteminfo_slash_scr_keyiteminfo_gml_70_0");
            tempkeyitemname = stringsetloc("RemoteBattery", "scr_keyiteminfo_slash_scr_keyiteminfo_gml_71_0");
            tempkeyitemchapter = 3;
            break;

        case 703:
            tempkeyitemdesc = stringsetsubloc("A digit for a combination lock.#You have collected [~1] out of [~2].", global.MacGuffin_count, global.AP_macguffin_required[3], "scr_keyiteminfo_slash_scr_keyiteminfo_gml_70_0");
