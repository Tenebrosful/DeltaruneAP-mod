    ...
    switch (spell)
    {
        ...
        case 4:
            ...
            if (cancelattack == 0)
            {
                ...
                if (global.chapter == 4 && i_ex(obj_hammer_of_justice_enemy) && obj_hammer_of_justice_enemy.justice_rudebuster < 1)
        ...
        case 10:
            ...
            if (cancelattack == 0)
            {
                ...
                if (global.chapter == 2 && instance_exists(obj_berdlyb2_enemy))
                {
        ...
        case 11:
            ...
            if (global.chapter == 2 && global.encounterno == 50)
            {
