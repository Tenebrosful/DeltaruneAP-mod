...
if (menu == 1 || menu == 2)
{
    ...
    if (menu == 1)
    {
        ...
        if (instance_exists(obj_writer) == false)
        {
            ...
            {
                global.fe = 6;
                global.msg[0] = "Er^1, I&havest&ran out&of stock./";
            }
...
if (menu == 10)
{
    ...
    draw_text(80, 380, string_hash_to_newline(stringsetloc("Selleth Pocket Items", "obj_shop1_slash_Draw_0_gml_292_0")));
    draw_text(80, 420, string_hash_to_newline(stringsetloc("Returnst", "obj_shop1_slash_Draw_0_gml_293_0")));
