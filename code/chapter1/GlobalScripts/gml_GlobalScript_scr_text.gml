    ...
    switch (arg0)
    {
        ...
        case 316:
            ...
            if (global.choice == 0)
            {
                ...
                if (global.customflags[global.custom_flags_indexes.broken_key_part_count] == 3 && scr_keyitemcheck(4))
                    which = 3;
        ...
        case 325:
            if (global.customflags[global.custom_flags_indexes.diamond_stand_bought])
            {
            ...
            else
            {
                ...
                global.choicemsg[2] = " ";
                global.choicemsg[3] = " ";
                global.msg[0] = string("* Interested in \\s0{0}^1? /", AP_get_location_reward_text(7));
        ...
        case 326:
            if (global.choice == 0)
            {
                ...
                {
                    AP_sendLocation(7);
                    global.customflags[global.custom_flags_indexes.diamond_stand_bought] = 1;
        ...
        case 327:
            if (global.customflags[global.custom_flags_indexes.heart_stand_bought])
            {
            ...
            else
            {
                ...
                global.choicemsg[2] = " ";
                global.choicemsg[3] = " ";
                global.msg[0] = string("* (Hathy offers \\s0{0}.^1)/", AP_get_location_reward_text(8));
        ...
        case 328:
            if (global.choice == 0)
            {
                ...
                {
                    AP_sendLocation(8);
                    global.customflags[global.custom_flags_indexes.heart_stand_bought] = true;
        ...
        case 330:
            ...
            global.msg[1] = string("\\E1* May we interest you in \\s0{0}?/", AP_get_location_reward_text(9));
            scr_susface(2, 2);
