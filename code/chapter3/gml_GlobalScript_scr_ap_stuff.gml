    ...
    if (global.darkzone == 1)
    {
        if (canshowtext)
        {
            if (file_exists("deathlink.flag") && file_exists("WelcomeToTheDead.youDied"))
            {
                ...
                {
                    if (i_ex(obj_chefs_game) && global.interact == 0)
                    {
                        with (obj_chefs_game)
                        {
                ...
                else if (!(room == room_board_1 || room == room_board_2 || room == room_dw_chef || room == room_dw_rhythm))
                {
            ...
            if (global.interact == 0 && instance_exists(obj_fadein) == 0 && instance_exists(obj_fadeout) == 0 && instance_exists(obj_dialoguer) == 0 && global.fighting == 0 && global.customflags[29] == 0 && !i_ex(obj_cutscene_master))
            {
                    ...
                    if (file_exists(ds_list_find_value(dslistitems, index)))
                    {
                        ...
                        if (fl != "")
                        {
                            ...
                            else if (trueitm >= 10000)
                            {
                                ...
                                if ((trueitm >= 11005 && trueitm <= 11007) || (trueitm >= 10013 && trueitm <= 10018) || (trueitm >= 11012 && trueitm <= 11020))
                                {
                                    later = 0;
                                    ...
                                    if (trueitm == 11018)
                                        global.customflags[25] = 1;
                                    
                                    if (trueitm == 11019)
                                        global.customflags[26] = 1;
                            ...
                            if (noroom == 0)
                            {
                                ...
                                if (notext == 0 && string_char_at(ds_list_find_value(dslistitems, index), 1) != "-")
                                {
                                    ...
                                    else if (trueitm >= 80000 && trueitm < 90000)
                                    {
                                        script_execute(scr_writetext, 0, scr_84_get_subst_string("* ~1 POINTs were added to your SCORE./%", trueitm - 80000), 0, 6);
                                    }
                                    else if (trueitm >= 70000)
                                    {
                                        if (trueitm == 70002)
                                        {
                                            script_execute(scr_writetext, 0, "* (You got a Remote Battery!)/%", 0, 6);
                                        }
                                        else
                                        {
                                            if (trueitm < 80000)
                                    ...
                                    {
                                        if ((trueitm >= 11005 && trueitm <= 11007) || (trueitm >= 10013 && trueitm <= 10018) || (trueitm >= 11012 && trueitm <= 11016) || trueitm == 11020)
                                        {
                                            if (trueitm == 11012)
                                                trueitm = 10002;
