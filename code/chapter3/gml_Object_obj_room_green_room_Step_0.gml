...
if (con == 60)
{
    ...
    if (global.customflags[23] == 1)
    {
        ...
        {
            c_msgnextloc("\\E3* Oh wait^1, you guys have it^1? Thanks!/", "obj_room_green_room_slash_Step_0_gml_695_0");
            c_msgnextloc("\\E2* I'll go return it to the big boss./", "obj_room_green_room_slash_Step_0_gml_695_0");
