...
/// CODE
    ...
    with (zapper_npc)
    {
        if ((global.customflags[global.custom_flags_indexes.remote_battery_used] == 1 || global.AP_macguffin_required[global.chapter - 1] < 1) && (global.flag[1055] >= 6 || !global.AP_shadow_mantle_holder_as_secret_boss || !global.AP_secret_bosses_mandatory))
            instance_destroy();
        else
            extflag = "zapper_cold";
    }
