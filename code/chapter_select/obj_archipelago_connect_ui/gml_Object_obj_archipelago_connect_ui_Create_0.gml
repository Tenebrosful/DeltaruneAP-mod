...
x_align = 80;
randomise();
musics = ["hip_shop.ogg", "town_day.ogg", "shop1.ogg", "castletown.ogg", "castle_funk_long.ogg", "greenroom_detune.ogg", "kris_piano_lancer_waltz.ogg", "shop_3.ogg", "field_of_hopes_insaneintherain_loop"];
