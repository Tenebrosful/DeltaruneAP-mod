...
if (state == 1)
{
    if (scr_havechar(5))
    {
        global.interact = 1;
        scr_speaker("noelle");
        msgsetloc(0, "\\E5* Looks like we need three people to ride this./");
        msgnextloc("\\E6* Do you think maybe we could get Susie to...?/%");
        d_make();
        con = 1;
    }
    else
    {
        ...
        for (var i = 0; i < partySize; i++)
        {
            ...
            var _rollSprites = [spr_kris_fall_ball, spr_kris_fall_ball, spr_susie_dw_fall_ball, spr_ralsei_teacup_enter, spr_noelle_shocked_dw];
