...
global.AP_connect_deadline = 10 * 30;
global.AP_item_from_server = [];
global.AP_special_textboxes_waiting = [];
...
global.AP_shadow_mantle_holder_as_secret_boss = false;
...
global.AP_ost_shuffle = false;
global.AP_ost_mapping = {}
global.AP_master_volume = 0.6;
global.AP_music_volume = 0.85;
global.AP_sfx_volume = 1;
global.AP_simplify_vfx = 0;
global.AP_disable_shakes = 0;
global.AP_auto_run = 0;
global.AP_voice_clips = 1;
global.AP_feather_controls = 0;
