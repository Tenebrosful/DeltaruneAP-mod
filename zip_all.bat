...
tar.exe -a -c -f "../../exportmods_zip/archipelago-2_1_3-2_bsdiff.zip" "*.bsdiff"

cd /d "../.."

cd /d "exportmods/xdelta/"
tar.exe -a -c -f "../../exportmods_zip/archipelago-2_1_3-2_xdelta.zip" "*"
...
tar.exe -a -c -f "../../exportmods_zip/archipelago-2_1_3-2_csx.zip" "*"
